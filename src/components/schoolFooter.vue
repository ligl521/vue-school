<template>
  <div class="schoolBottom">
    <footer>
      <section id="footer-sec" style="padding:30px 0;">
        <div class="container ">
          <div class="row">
              <div class="col-xs-12 col-md-4 col-lg-4 text-center footerh5">
                    <h4 style="font-size: 20px;">关于新学说</h4>
                    <div class="center-block text-left" style="text-indent:2em;line-height: 1.8;">
                        <p style="font-size: 16px;">新学说(NewSchool Insight)是由国际学校资深专家共同打造的国际学校服务平台。 旗下有新学说传媒和新学说国际教育研究院两大品牌。为国际学校提供行业最新资讯，会议组织， 海外考察；研究报告，行业数据库；学校投建，运营管理，品牌管理，人才培养等专业咨询服务。
                        <a id="hovea" href="https://www.xinxueshuo.cn/#/about" target="_blank">more..</a>
                        </p>
                    </div>
                </div>
                <div class="col-xs-12 col-md-4 col-lg-4 text-center footerh5">
                ...
                <div class="col-xs-12 col-md-2 col-lg-2 text-center footerh5">
                ...
                <div class="col-xs-12 col-md-2 col-lg-2 text-center footerh5">
                    ...
                    <div class="social-links">
                        <a href="https://www.xinxueshuo.cn/#/" target="_blank"><img alt="新学说官网" height="120" width="120" src="http://data.xinxueshuo.cn/nsi/assets/img/www.png">
                        </a>
                        <a href="https://www.xinxueshuo.cn/#/" target="_blank" style="color: #dfd1d1;font-size: 16px;margin-top: 20px;display: inline-block;">www.xinxueshuo.cn</a>
                    </div>
                </div>
            </div>
        </div>

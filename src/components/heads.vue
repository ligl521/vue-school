    ...
    >
      <el-tabs stretch v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="账号密码" name="second">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm" show-message="false" status-icon="true">
  ...
  methods: {
    ...
    send_msg(formName) {
      ...
      var params = {
         ...
         passWord:self.ruleForm.userMail
      }
      console.log(self.ruleForm.userMail)
      console.log(self.ruleForm.pwd)
      axios({
        method: "post",

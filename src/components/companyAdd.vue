<template>
    <div>
        <div class="addBox">
            ...
            <div class="first">
                <h4>基本信息</h4>
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" :inline="true" class="demo-ruleForm">
                    ...
                    <el-form-item label="所在地区" prop="address">
                        <el-cascader size="large" :options="options" v-model="ruleForm.address"  @change="handleChange" ref="cascaderAddr"></el-cascader>
                    </el-form-item>
...
export default {
    ...
    data(){
        return{
            ...
            rules: {
                ...
                time:[
                    { required: true, message: "请输入成立时间，不添加月份", trigger: "blur" },
                    { min: 4, max: 4, message: "成立时间为4位,例如：2019", trigger: "change" }
                ],
                address:[
                ...
                companyLabel: [
                    { type: 'array', required: true, message: '请至少选择一个机构标签', trigger: 'change' }
                ],
            },
            labelSplice:'',
            labelJoin:'',
    ...
    methods:{
        ...
        submit(formName){
            this.labelSplice=this.ruleForm.companyLabel.slice(0,this.ruleForm.companyLabel.length)
